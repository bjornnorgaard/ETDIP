...
case 0 % Draw figure
	...
	H.menu(4) = uimenu(H.menu(3),'Label','&Load',...
		'Callback','train(7)');
	H.menu(5) = uimenu(H.menu(3),'Label','&Save',...
		'Callback','train(6)');
	...
	H.ax(2) = axes('position',[0.5+180/width 190/height 0.5-300/width 1-500/height],...
		'XTick',[],'YTick',[],'Box','on');	
	...
	uicontrol('Style','text',...
		'Units','normalized',...
		'Position',[510/width (height-120)/height 180/width 50/height],...
   ...
   H.button(1) = uicontrol('Style','pushbutton',... % Segment button
      'Units','normalized', ...
      'Position',[700/width (height-95)/height 30/width 30/height],...
      'CallBack','train(2)');
	
	uicontrol('Style','text',...
		'Units','normalized',...
		'Position',[485/width (height-150)/height 290/width 30/height],...
		'String','- - - - - - - Character navigation - - - - - - -',...
		'HorizontalAlignment','center',...
		'FontSize',10);
	
   H.button(2) = uicontrol('Style','pushbutton',... % (Next) Character navigation
      'Units','normalized', ...
      'Position',[640/width (height-180)/height 30/width 30/height],...
      'FontSize',10,...
      'String','>>',...
      'CallBack','train(3)');
   ...
   H.button(3) = uicontrol('Style','pushbutton',... % (Previous) Character navigation
      'Units','normalized', ...
      'Position',[590/width (height-180)/height 30/width 30/height],...
      'FontSize',10,...
      'String','<<',...
      'CallBack','train(4)');
	...
	uicontrol('Style','text',...
		'Units','normalized',...
		'Position',[510/width (height-240)/height 90/width 30/height],...
		'String','Class Label',...
		'HorizontalAlignment','left',...
		'FontSize',10);
	...
	H.edit(1) = uicontrol('Style','edit',...
		'Units','normalized',...
		'Position',[610/width (height-235)/height 90/width 30/height],...
		'HorizontalAlignment','left',...
		'FontSize',10,...
		'CallBack','train(5)');
   ...
   H.button(4) = uicontrol('Style','pushbutton',... % Determine Character Features
	...
	H.checkbox(1) = uicontrol('Style','checkbox',...
		'Units','normalized', ...
		'Position',[530/width 130/height 120/width 30/height],...
		'HorizontalAlignment','left',...
		'String','Eccentricity',...
		'FontSize',10);
	
	H.checkbox(2) = uicontrol('Style','checkbox',...
		'Units','normalized', ...
	...
	H.checkbox(3) = uicontrol('Style','checkbox',...
		'Units','normalized', ...
	...
	H.checkbox(4) = uicontrol('Style','checkbox',...
		'Units','normalized', ...
	...
	H.checkbox(5) = uicontrol('Style','checkbox',...
		'Units','normalized', ...
	...
	H.checkbox(6) = uicontrol('Style','checkbox',...
		'Units','normalized', ...
